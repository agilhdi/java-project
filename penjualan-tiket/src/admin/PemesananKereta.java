 ...
 * @author mamur
 */
public class PemesananKereta extends javax.swing.JFrame {
...
//        Mmbuat ID PenumpangKereta Otomatis
        autoid();
...
//        Memanggil Data Kelas
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "TIKET KERETA", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 18))); // NOI18N
        ...
        fbayar.setBackground(new java.awt.Color(153, 255, 153));
    ...
    private void autoid(){
       try{
            ...
            String sql = "SELECT COUNT(id) as kode FROM penumpang_kereta";
    ...
    private void simpan(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpan
        ...
        try{
            con = Koneksi.getKoneksi();
            String sql = "INSERT INTO penumpang_kereta VALUES('"+fid.getText()+"','"+fnama.getText()+"','"+falamat.getText()+"','"+stasiun_awal.getText()+"','"+stasiun_tujuan.getSelectedItem()+"','"+berangkat.getText()+"','"+tiba.getText()+"','"+tanggal.getDate()+"','"+ckereta.getSelectedItem()+"','"+cgerbong.getSelectedItem()+"','"+sdewasa.getValue()+"','"+sanak.getValue()+"','"+ltotal.getText()+"')";
            st = con.createStatement();
            st.execute(sql);
            this.dispose();
            Index.oke();
            ...
            String reportName = "src/report/TiketKereta.jasper";
    ...
    private void kelas(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kelas
        ...
        if((cgerbong.getSelectedItem().equals("Eksekutif 1")) || (cgerbong.getSelectedItem().equals("Eksekutif 2"))){
            try{    
                ...
                String sql1 = "SELECT * FROM harga_kereta WHERE id='1'";
                rs = st.executeQuery(sql1);
                while(rs.next()){
                    hdewasa.setText(rs.getString("harga"));
                }
            
                String sql2 = "SELECT * FROM harga_kereta WHERE id='2'";
            ...
            try{    
                ...
                String sql1 = "SELECT * FROM harga_kereta WHERE id='3'";
                rs = st.executeQuery(sql1);
                while(rs.next()){
                    hdewasa.setText(rs.getString("harga"));
                }
            
                String sql2 = "SELECT * FROM harga_kereta WHERE id='4'";
                rs = st.executeQuery(sql2);
                while(rs.next()){
                    hanak.setText(rs.getString("harga"));
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PemesananKereta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
