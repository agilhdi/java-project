 ...
 * @author mamur
 */
public class PenumpangKereta extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            String reportName = "src/report/PenumpangKereta.jasper";
    ...
    private void HapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HapusActionPerformed
        try{
            ...
            if (pesan == JOptionPane.YES_OPTION){
                ...
                String sql = "DELETE FROM penumpang_kereta";
    ...
    private void data(){
     try{
            con = Koneksi.getKoneksi();
            String sql1 = "SELECT * FROM penumpang_kereta order by id ASC";
            st = con.createStatement();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PenumpangKereta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
